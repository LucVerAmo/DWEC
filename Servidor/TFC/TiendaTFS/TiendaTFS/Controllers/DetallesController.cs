...
namespace TiendaTFS.Controllers
{
    public class DetallesController : Controller
    {
        ...
        public DetallesController(MvcTiendaTFSContexto context)
        {
            _context = context;
        }
        ...
        {
            var mvcTiendaTFSContexto = _context.Detalles.Include(d => d.Pedido).Include(d => d.Producto);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTiendaTFSContexto.Detalles'  is null.");
            }
            var detalle = await _context.Detalles.FindAsync(id);
            if (detalle != null)
            {
