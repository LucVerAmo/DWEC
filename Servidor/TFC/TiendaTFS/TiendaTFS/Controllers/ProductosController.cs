...
namespace TiendaTFS.Controllers
{
    ...
    public class ProductosController : Controller
    {
        ...
        public ProductosController(MvcTiendaTFSContexto context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTiendaTFSContexto.Productos'  is null.");
            }
            var producto = await _context.Productos.FindAsync(id);
            if (producto != null)
            {
