...
namespace TiendaTFS.Controllers
{
    ...
    public class EstadosController : Controller
    {
        ...
        public EstadosController(MvcTiendaTFSContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Estados != null ? 
                          ...
                          Problem("Entity set 'MvcTiendaTFSContexto.Estados'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTiendaTFSContexto.Estados'  is null.");
            }
            var estado = await _context.Estados.FindAsync(id);
            if (estado != null)
            {
