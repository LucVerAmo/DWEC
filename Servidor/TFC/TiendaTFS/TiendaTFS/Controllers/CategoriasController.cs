...
namespace TiendaTFS.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(MvcTiendaTFSContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorias != null ? 
                          ...
                          Problem("Entity set 'MvcTiendaTFSContexto.Categorias'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTiendaTFSContexto.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
