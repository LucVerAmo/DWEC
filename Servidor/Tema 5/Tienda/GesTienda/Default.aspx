...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <br />
                <asp:Login ID="Login1" runat="server" class="LoginPos" OnAuthenticate="Login1_Authenticate">
                    <LayoutTemplate>
        ...
        <br />
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Registrarse.aspx" class="botonEnl">Registrarse</asp:LinkButton>
        <br />
        <br />
        <div class="pie">
                <br />
