...
namespace FacturaWS
{
    ...
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/", Description = "Servicio Web para la obtención de cálculos en líneas de factura.")]
    ...
    public class CalculosFacturaWS : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public Calculos CalculosLineaFactura(double cantidad, double precio, double tipo_descuento, double tipo_iva)
        {
