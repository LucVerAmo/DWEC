...
<div id="contedor">
    <div id="enlaces">
        ...
        <asp:LinkButton ID="LinkButton2" runat="server" Class="link" PostBackUrl="~/EmpleadosCalendar.aspx">Empleados </asp:LinkButton>
        <asp:LinkButton ID="LinkButton3" runat="server" Class="link" PostBackUrl="~/Prestaciones1.aspx">Presentaciones </asp:LinkButton>
    </div>
</div>
    <hr id="hrlink"/>
